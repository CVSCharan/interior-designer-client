        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Creating beautiful spaces that inspire and delight. Our
              professional interior design services transform your vision into
              reality.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">info@interiordesign.com</span>
              </li>
              <li className="flex items-start">
                <svg
                  className="h-6 w-6 text-indigo-400 mr-2"
